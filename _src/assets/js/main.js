...
function changePalette2(color4Result, color5Result, color6Result) {
    ...
    color1Result.classList.add("js-box__color4");
    color2Result.classList.add("js-box__color5");
    color3Result.classList.add("js-box__color6");
}

function changePalette3(color7Result, color8Result, color9Result) {
    color1Result.classList.toggle("js-box__color1");
    color2Result.classList.toggle("js-box__color2");
    color3Result.classList.toggle("js-box__color3");
    color1Result.classList.add("js-box__color7");
    color2Result.classList.add("js-box__color8");
    color3Result.classList.add("js-box__color9");
}
