...
function showURL(data) {
  if (data.success) {
    // Show URL card
    urlCard.innerHTML =
      '<h3 class="created_card_h3">La tarjeta ha sido creada:</h3> <a class="created_card_small" href=' +
      data.cardURL +
      ">" +
      data.cardURL +
      "</a>";
    ...
    twitterButton.href = `https://twitter.com/intent/tweet?text=Mira mi tarjeta de visita ${
      data.cardURL
    }`;
  } else {
